        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('doctor.reg') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                        <label for="exampleFormControlSelect1" class="col-md-4 control-label">Registration Type</label>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="regid" value="{{ old('regid') }}" required autofocus>
